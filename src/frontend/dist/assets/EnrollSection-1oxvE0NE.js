...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, u as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, l as lookupResultToBuffer, R as RequestStatusResponseStatus, U as UnknownError, d as RequestStatusDoneNoReplyErrorCode, e as RejectError, f as CertifiedRejectErrorCode, g as UNREACHABLE_ERROR, I as InputError, h as InvalidReadStateRequestErrorCode, i as ReadRequestType, k as Principal, m as IDL, n as MissingCanisterIdErrorCode, H as HttpAgent, o as encode, Q as QueryResponseStatus, p as UncertifiedRejectErrorCode, q as isV3ResponseBody, s as isV2ResponseBody, t as UncertifiedRejectUpdateErrorCode, v as UnexpectedErrorCode, w as decode, x as Subscribable, y as pendingThenable, z as resolveEnabled, A as shallowEqualObjects, B as resolveStaleTime, D as noop$1, F as environmentManager, G as isValidTimeout, J as timeUntilStale, K as timeoutManager, L as focusManager, N as fetchState, O as replaceData, V as notifyManager, W as hashKey, Y as getDefaultState, r as reactExports, Z as shouldThrowError, _ as useQueryClient, $ as useInternetIdentity, a0 as createActorWithConfig, c as createLucideIcon, a1 as Record, a2 as Opt, a3 as Variant, a4 as Service, a5 as Func, a6 as Vec, a7 as Nat8, a8 as Text, a9 as Nat, aa as Bool, ab as Null, ac as Int, j as jsxRuntimeExports, a as cn, ad as createSlot$1, ae as composeRefs, af as React, ag as useComposedRefs, ah as reactDomExports, ai as React$1, aj as ReactDOM } from "./index-r30eH0tm.js";
import { M as MapPin, P as Phone, a as Mail, C as Clock, S as SiFacebook, b as SiInstagram } from "./index-CBa1Jxvb.js";
...
const Apple = createLucideIcon("apple", __iconNode$8);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const EnrollmentRequest = Record({
  "email": Text,
  "childAge": Text,
  "message": Text,
  "programInterest": Text,
...
Service({
  ...
  "listEnrollments": Func([], [Vec(Enrollment)], ["query"]),
  "listTestimonials": Func([], [Vec(Testimonial)], ["query"]),
  "markEnrollmentReviewed": Func([EnrollmentId], [], []),
  "submitEnrollment": Func([EnrollmentRequest], [EnrollmentId], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const Enrollment2 = IDL2.Record({
    ...
    "childAge": IDL2.Text,
    "message": IDL2.Text,
    "programInterest": IDL2.Text,
    "phone": IDL2.Text,
    "childName": IDL2.Text,
    "parentName": IDL2.Text
  });
  ...
  const Testimonial2 = IDL2.Record({
    ...
    "quote": IDL2.Text,
    "rating": IDL2.Nat,
    "childProgram": IDL2.Text,
    "parentName": IDL2.Text
  });
  const EnrollmentRequest2 = IDL2.Record({
    "email": IDL2.Text,
    "childAge": IDL2.Text,
    "message": IDL2.Text,
    "programInterest": IDL2.Text,
  ...
  return IDL2.Service({
    ...
    "getStats": IDL2.Func(
      ...
      [
        IDL2.Record({
          "totalEnrollments": IDL2.Nat,
          "totalTestimonials": IDL2.Nat
        })
      ],
      ["query"]
    ),
    "listEnrollments": IDL2.Func([], [IDL2.Vec(Enrollment2)], ["query"]),
    "listTestimonials": IDL2.Func([], [IDL2.Vec(Testimonial2)], ["query"]),
    "markEnrollmentReviewed": IDL2.Func([EnrollmentId2], [], []),
    "submitEnrollment": IDL2.Func([EnrollmentRequest2], [EnrollmentId2], [])
  });
};
...
class Backend {
  ...
  async markEnrollmentReviewed(arg0) {
    if (this.processError) {
      try {
...
function from_candid_EnrollmentStatus_n11(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n12(_uploadFile, _downloadFile, value);
}
function from_candid_Enrollment_n9(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n12(_uploadFile, _downloadFile, value) {
  return "pending" in value ? "pending" : "reviewed" in value ? "reviewed" : value;
}
...
function EnrollSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      style: {
        background: "linear-gradient(135deg, #FF7043 0%, #F06292 50%, #FF8A65 100%)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            "aria-hidden": "true",
            children: [
              FLOAT_EMOJIS.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-full px-5 py-2 mb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-sm font-body font-semibold", children: "🎉 Enrollment Open 2024–2025" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl md:text-5xl lg:text-6xl text-white mb-5 leading-tight", children: "Enroll Your Child Today! 🎉" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-white/90 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed", children: "Take the first step towards your child's bright future. Our admissions team will reach out within 24 hours to schedule a personal school tour." })
              ]
            }
          ),
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-white text-2xl mb-5", children: "Get In Touch" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-4 h-4 text-white" }) }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-white text-sm", children: "Address" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-white/80 text-sm leading-snug", children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-4 h-4 text-white" }) }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-white text-sm", children: "Phone" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "a",
                                {
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-4 h-4 text-white" }) }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-white text-sm", children: "Email" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "a",
                                {
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-4 h-4 text-white" }) }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-white text-sm", children: "Hours" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-white/80 text-sm", children: "Mon–Sat · 8:00 AM – 3:00 PM" })
                            ] })
                          ] })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mt-5 pt-5 border-t border-white/20", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "a",
                            {
                              ...
                              children: /* @__PURE__ */ jsxRuntimeExports.jsx(SiFacebook, { className: "w-4 h-4 text-white" })
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "a",
                            {
                              ...
                              className: "w-9 h-9 rounded-full flex items-center justify-center transition-smooth hover:scale-110",
                              style: { background: "rgba(255,255,255,0.2)" },
                              children: /* @__PURE__ */ jsxRuntimeExports.jsx(SiInstagram, { className: "w-4 h-4 text-white" })
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-white/60 text-xs ml-1", children: "Follow us for updates!" })
                        ] })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-white text-xl mb-4", children: "Why Enroll With Us?" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: WHY_ENROLL.map(({ icon: Icon2, text, color }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              className: "w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0",
                              style: { background: color },
                              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-3.5 h-3.5 text-white" })
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-white/85 text-sm", children: text })
                        ] }, text)) })
                      ]
                    }
                  )
                    ...
                    children: submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      motion.div,
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-foreground/60 text-base max-w-xs mx-auto mb-6", children: "We'll contact you within 24 hours to schedule your school tour." }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center gap-3", children: ["🌟", "🌈", "🚀", "❤️", "🎓"].map((e) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl float-fast", children: e }, e)) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "button",
                            {
                              type: "button",
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-2", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "h3",
                              {
                                ...
                                style: { color: "#7C3AED" },
                                children: "Enrollment Application"
                              }
                            ),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-foreground/50 text-sm mt-1", children: "All fields marked * are required" })
                          ] }),
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                              ...
                              errors.parentName && /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "p",
                                {
                                  ...
                                  children: errors.parentName.message
                                }
                              )
                            ] }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                              ...
                              errors.childName && /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "p",
                                {
                                  "data-ocid": "enroll.child_name.field_error",
                                  className: "font-body text-red-500 text-xs",
                                  children: errors.childName.message
                                }
                              )
                            ] }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "font-body font-semibold text-sm", children: "Child's Age *" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                Controller,
                                {
                                  name: "childAge",
                                      ...
                                      children: [
                                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                                          SelectTrigger,
                                          {
                                            ...
                                            children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select age" })
                                          }
                                        ),
                                        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: AGE_OPTIONS.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                                          SelectItem,
                                          {
                                            value: opt.value,
                                            className: "font-body",
                              ...
                              errors.childAge && /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "p",
                                {
                                  "data-ocid": "enroll.child_age.field_error",
                                  className: "font-body text-red-500 text-xs",
                                  children: errors.childAge.message
                                }
                              )
                            ] }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "font-body font-semibold text-sm", children: "Program Interest *" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                Controller,
                                {
                                  name: "program",
                                  ...
                                  render: ({ field }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                    Select,
                                    {
                                      ...
                                      children: [
                                        ...
                                        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: PROGRAM_OPTIONS.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                                          SelectItem,
                                          {
                                            value: opt.value,
                                            className: "font-body",
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "button",
                            {
                              ...
                              children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center justify-center gap-3", children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-5 h-5 animate-spin" }),
                                "Submitting..."
                              ] }) : "Submit Enrollment →"
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-center text-foreground/40 text-xs", children: "By submitting, you agree to our Privacy Policy. We never share your data." })
                        ]
                      }
                    )
                  }
