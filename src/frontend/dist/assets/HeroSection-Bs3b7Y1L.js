...
import { S as STATS } from "./school-DD2wU6QB.js";
...
function HeroSection() {
  const scrollToEnroll = reactExports.useCallback(() => {
    var _a;
    (_a = document.getElementById("enroll")) == null ? void 0 : _a.scrollIntoView({ behavior: "smooth" });
  }, []);
  const scrollToPrograms = reactExports.useCallback(() => {
    var _a;
    (_a = document.getElementById("programs")) == null ? void 0 : _a.scrollIntoView({ behavior: "smooth" });
  }, []);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("style", { dangerouslySetInnerHTML: { __html: BG_KEYFRAMES } }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        style: {
          backgroundImage: "linear-gradient(135deg, #7C3AED 0%, #A855F7 15%, #EC4899 35%, #F97316 55%, #0D9488 75%, #EAB308 90%, #7C3AED 100%)",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              "aria-hidden": "true",
              children: [
                FLOATING_ELEMENTS.map((el) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                  ...
                  `${el.emoji}-${el.top}-${el.left}`
                )),
                FLOATING_ELEMENTS.slice(0, 4).map((el) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex-1 flex flex-col items-center justify-center text-center px-4 pt-28 pb-16 max-w-6xl mx-auto w-full", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                style: {
                  background: "linear-gradient(90deg, rgba(255,255,255,0.25), rgba(255,255,255,0.12), rgba(255,255,255,0.25))",
                  backgroundSize: "200% auto",
                  animation: "shimmerBadge 3s linear infinite, badgePop 0.7s ease forwards",
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Award-Winning Preschool Since 2009" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg", children: "⭐" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.h1,
              {
                ...
                style: {
                  ...
                  color: "#fff",
                  textShadow: "0 2px 4px rgba(0,0,0,0.25), 0 0 60px rgba(255,255,255,0.15)"
                },
                children: [
                  "Cutie Pie Kids",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ...
                    {
                      style: {
                        background: "linear-gradient(135deg, #FDE68A, #FCD34D, #F97316)",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.p,
              {
                ...
                children: "Where Learning Meets Play"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.p,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "opacity-90", children: "Ages 18 months to 6 years" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      style: {
                        ...
                        boxShadow: "0 6px 28px rgba(249,115,22,0.5), 0 2px 8px rgba(0,0,0,0.2), inset 0 1px 0 rgba(255,255,255,0.3)"
                      },
                      onMouseEnter: (e) => {
                        e.currentTarget.style.boxShadow = "0 10px 40px rgba(249,115,22,0.7), 0 4px 16px rgba(0,0,0,0.25), inset 0 1px 0 rgba(255,255,255,0.3)";
                      },
                      onMouseLeave: (e) => {
                        e.currentTarget.style.boxShadow = "0 6px 28px rgba(249,115,22,0.5), 0 2px 8px rgba(0,0,0,0.2), inset 0 1px 0 rgba(255,255,255,0.3)";
                      },
                      children: "🎓 Enroll Now"
                    }
                  ),
                ...
                children: STATS.map((stat, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  motion.div,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-white/80 text-xs sm:text-sm", children: stat.label })
                    ]
                  },
                  stat.id
                ))
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
                ...
                children: PROGRAM_CARDS.map((card, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  motion.button,
                  {
                    type: "button",
                    initial: { opacity: 0, y: 24 },
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-2", children: card.emoji }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-white/75 text-sm", children: card.ages })
                    ]
                  },
                  card.title
                ))
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-xs tracking-widest uppercase", children: "Discover More" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    style: {
