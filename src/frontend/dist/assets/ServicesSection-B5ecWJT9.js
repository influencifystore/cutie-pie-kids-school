...
const THERAPY_SERVICES = [
  {
    ...
    description: "Expert speech-language therapy to help children communicate with confidence, clarity, and joy.",
    accent: "#7C3AED",
  ...
  },
  {
    ...
    description: "Developing fine motor skills and independence through targeted, play-based activities tailored to each child.",
    accent: "#0D9488",
  ...
  },
  {
    ...
    description: "Emotional wellbeing and anger management support for children's mental health and social flourishing.",
    accent: "#EC4899",
...
function ServicesSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      style: {
        background: "linear-gradient(145deg, #1e1b4b 0%, #312e81 40%, #4c1d95 70%, #1e1b4b 100%)"
      },
      children: [
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h2",
                  {
                    ...
                    children: "Specialized Support Services"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 text-lg max-w-2xl mx-auto leading-relaxed font-body", children: "Every child deserves the right support to reach their full potential. Our dedicated specialists are here to help." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8", children: THERAPY_SERVICES.map((service, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 text-6xl drop-shadow-xl group-hover:scale-110 transition-transform duration-300", children: service.emoji })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-7", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl font-bold text-white mb-3", children: service.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/65 text-sm leading-relaxed mb-5 font-body", children: service.description }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2 mb-7", children: service.features.map((feat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "li",
                    {
            ...
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl font-bold text-white mb-1", children: "Ready to get started?" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 text-sm font-body", children: "Schedule a free consultation with our specialist team today." })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
