...
const APPROACHES: Approach[] = [
  {
    ...
    name: "Montessori",
    description:
      "Child-led exploration with curated materials fostering independence and a love of learning at each child's own pace.",
    accent: "#7C3AED",
  ...
  },
  {
    ...
    name: "Reggio Emilia",
    description:
      "Project-based inquiry where the child's curiosity drives discovery and the environment becomes the third teacher.",
    accent: "#EC4899",
  ...
  },
  {
    ...
    description:
      "Scientifically proven methods that harness children's natural joy of play to build cognitive and social skills.",
    accent: "#F97316",
  ...
  },
  {
    ...
    name: "Waldorf",
    description:
      "Rhythmic routines, nature immersion, and imaginative arts nurturing the whole child — head, heart, and hands.",
    accent: "#0D9488",
  ...
  },
  {
    ...
    description:
      "Real-world challenges and collaborative projects that build critical thinking, creativity, and communication.",
    accent: "#EAB308",
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-white/60 text-lg max-w-2xl mx-auto leading-relaxed font-body">
            We blend the world's most respected early childhood frameworks to
            create a truly exceptional learning experience.
          </p>
        </motion.div>

        {/* Approach Cards — horizontal scroll on mobile, grid on desktop */}
        <div
        ...
        <div className="flex justify-center gap-2 mt-6 md:hidden">
          {APPROACHES.map((approach, index) => (
            <div
              ...
              style={{
                background:
                  index === 0 ? approach.accent : "rgba(255,255,255,0.25)",
              }}
            />
          ))}
        </div>
