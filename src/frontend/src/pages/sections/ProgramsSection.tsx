...
const PROGRAM_CARDS: ProgramCard[] = [
  {
    ...
    description:
      "A warm, nurturing environment where your little one takes their very first steps into social play, sensory discovery, and the magic of learning through joy.",
    icon: "🎠",
    features: [
  ...
  },
  {
    ...
    description:
      "Professional full-day care in a safe, stimulating space. Your child is loved, watched over, and engaged in enriching activities from morning to evening.",
    icon: "🏠",
    features: [
  ...
  },
  {
    ...
    description:
      "Gentle introduction to structured learning, creative expression, and friendship — building the social and emotional foundations every child needs.",
    icon: "🌱",
    features: [
  ...
  },
  {
    ...
    description:
      "Hands-on learning that sparks curiosity. Through play, projects, and guided discovery, children build confidence and essential pre-school skills.",
    icon: "🎒",
    features: [
  ...
  },
  {
    ...
    description:
      "A step up in structured learning — reading readiness, number concepts, logical thinking, and advanced social skills to prepare for the next chapter.",
    icon: "📖",
    features: [
  ...
  },
  {
    ...
    description:
      "Energising after-school sessions packed with art, music, coding, sports, and creative projects — the perfect balance of fun and focused enrichment.",
    icon: "🎨",
    features: [
      "Art, music & drama",
      "Homework support",
      ...
      >
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center gap-4">
            ...
            <p className="font-body text-sm text-white/80 text-center leading-relaxed max-w-[200px]">
              {card.tagline}
            </p>
            <div className="mt-1 text-white/60 text-xs font-body flex items-center gap-1">
...
export function ProgramsSection() {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(180deg, #f8f4ff 0%, #fff0f9 50%, #fff7ed 100%)",
      }}
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle at 10% 15%, #7C3AED18 0%, transparent 45%), radial-gradient(circle at 90% 85%, #EC489918 0%, transparent 45%), radial-gradient(circle at 50% 50%, #0D948812 0%, transparent 55%)",
        }}
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="font-body text-foreground/60 text-base max-w-2xl mx-auto leading-relaxed">
            Six lovingly designed programs for children from 18 months to 12
            years. Hover each card to discover what makes every program special.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="font-body text-foreground/55 text-sm max-w-sm">
            Join 500+ happy families at Cutie Pie Kids Playschool — where every
            day is an adventure.
          </p>
          <button
            type="button"
